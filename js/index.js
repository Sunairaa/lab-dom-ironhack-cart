...
function updateSubtotal(product) {
  ...
  updateValue = Number(price) * Number(quantity);
  let subtotal = product.querySelector('.subtotal span');
  subtotal.innerHTML = `${Number(updateValue)}`;
...
function createProduct() {
  ...
  const productName = document.querySelector('.create-product td input[type = text]');
